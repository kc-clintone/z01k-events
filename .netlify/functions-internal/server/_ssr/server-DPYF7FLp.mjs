...
import { i as requestHandler, r as getResponse } from "./request-response-C5A0Toox.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DDHIS76s.mjs");
